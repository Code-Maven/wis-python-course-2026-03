...
* How to secure our code-base?
    * [Bobby Tables (SQL injection attack](https://bobby-tables.com/)
...
* [Docker](https://code-maven.com/docker/) image and container
...
* Create a web application using `flask` from the code in the `day07` folder. Later I moved the code to the `day08` folder, so you can see it there now. A few comments:
    ...
    * There are no tests.
* My [Flask slides](https://python.code-maven.com/python-flask/)
