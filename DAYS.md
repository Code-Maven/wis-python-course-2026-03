...
* [Watch the 1st video](https://git.code-maven.com/git-maven/creating-a-website-on-github-pages-using-markdown)
...
* [Watch the 2nd video](https://git.code-maven.com/git-maven/using-git-on-windows-in-vs-code).
